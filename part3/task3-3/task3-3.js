...
window.onscroll = function(){
	var table = getNode('table');
	var th = table.childNodes[0];
	if(window.pageYOffset < 35) {
		 th.className = 'normal';
	}
	if(window.pageYOffset >=35 && window.pageYOffset < 585) {
        th.className = 'first-fix';
...
addItems(['bean6', '45', '23', '23', '438']);
addItems(['bean7', '34', '6', '15', '304']);
addItems(['bean8', '87', '9', '17', '256']);
addItems(['bean9', '66', '7', '14', '478']);
addItems(['bean10', '29', '44', '100', '278']);
addItems(['bean11', '12', '13', '12', '1238']);
addItems(['bean12', '19', '18', '15', '1264']);
addItems(['bean13', '17', '19', '18', '156']);
addItems(['bean14', '13', '11', '11', '178']);
addItems(['bean15', '110', '110', '110', '1537']);
addSeqMethod('语文');
addSeqMethod('数学');
addSeqMethod('英语');
addSeqMethod('总分');